...
public class ReadView {
	...
	public static void listar(JPanel panelAntigo , JFrame frame) {
		JPanel novoPanel = new JPanel();
		MainView.atualizarPanel(novoPanel, panelAntigo, frame);
		ReadMenuListaProduto readMenuListaProduto = new ReadMenuListaProduto(novoPanel, panelAntigo, frame);
