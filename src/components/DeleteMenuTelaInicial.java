...
public class DeleteMenuTelaInicial extends JPanel {

	/**
	 * Create the panel.
	 */
	public DeleteMenuTelaInicial(JPanel panelAtual, JPanel panelAntigo, JFrame frame) {
		...
		JLabel lblNewLabel = new JLabel("Bem vindo ao delete menu.");
		...
		JLabel lblNewLabel_1 = new JLabel("Gostaria de excluir algum produto?");
		...
		gbc_btnProsseguir.insets = new Insets(0, 0, 0, 5);
		gbc_btnProsseguir.gridx = 1;
		gbc_btnProsseguir.gridy = 9;
		add(btnProsseguir, gbc_btnProsseguir);
		...
		prosseguir(btnProsseguir, panelAtual, frame);
	}

	public void prosseguir(JButton button, JPanel novoPanel, JFrame frame) {
		button.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				DeleteView.listagemItem(novoPanel, frame);
			}
		});
	}
}